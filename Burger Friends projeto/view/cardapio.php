...
<head>
    ...
    <title>Burger Friends - Cardápio</title>
...
<body bgcolor="brown">
  ...
  <nav id="navbar"class="navbar navbar-expand-lg navbar-light bg-dark">
      ...
      <section class="lanches bg-dark">
        <h2 class="rubik" >Lanches mais Pedidos</h2>

        <div class="produtos bg-dark">
        <?php
        require_once("../model/Manager.php");
        $manager = new Manager();
        $manager->Categorias('Hamburguer');
        ?>
        </div>
      </section>
      ...
      <section class="lanches bg-dark" id="acompanhamentos">
        <h2 class="rubik" >Acompanhamentos</h2>

        <div class="produtos bg-dark">
        <?php
        require_once("../model/Manager.php");
        $manager = new Manager();
        $manager->Categorias('Acompanhamento');
        ?>
        </div>
      </section>


      <section class="lanches bg-dark" id="bebidas">
        <h2 class="rubik">Bebidas</h2>

        <div class="produtos bg-dark" >
        <?php
        require_once("../model/Manager.php");
        $manager = new Manager();
        $manager->Categorias('Bebida');
        ?>
        </div>
      </section>


      <section class="lanches bg-dark" id="sobremesas">
        <h2 class="rubik">Sobremesas</h2>

        <div class="produtos bg-dark">
        <?php
        require_once("../model/Manager.php");
        $manager = new Manager();
        $manager->Categorias('Sobremesa');
        ?>
        </div>
      </section>
