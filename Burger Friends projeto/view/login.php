...
<head>
    ...
    <title>Burger Friends - Login</title>
  ...
  <nav id="navbar"class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="main-login">
        <div class="left-login">
            <h1>Faça login<br>E peça já seu lanche</h1>
            <img src="img/hamburger.svg" class="left-login-image" alt="Hambuger animação">
        </div>
        <div class="right-login">
            <div class="card-login">
                ...
                <h3>Não tem cadastro?</h3><a href="cadastro-teste.php">Clique aqui</a>
              </form>
            </div>
        </div>
    </div>
